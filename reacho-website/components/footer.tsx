  ...
  return (
    <footer className="bg-gray-900 z-10">
      <div className="mx-auto max-w-7xl px-6 py-8 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="flex mt-8 md:order-1 md:mt-0">
          <p className="text-center text-xs leading-5 text-gray-400 pr-5">
            &copy; Reacho {new Date().getFullYear()}. All rights reserved.
          </p>
          <a
            href="/terms"
            className="text-center text-xs leading-5 text-gray-400 hover:text-gray-500 cursor-pointer"
          >
            Terms of Service<span className="px-[6px]">|</span>
          </a>
          <Link
            href="/privacy"
            className="text-center text-xs leading-5 text-gray-400 hover:text-gray-500 cursor-pointer"
          >
            Privacy Policy<span className="px-[6px]">|</span>
          </Link>
          <a
            href="/contact-us"
            className="text-center text-xs leading-5 text-gray-400 hover:text-gray-500 cursor-pointer"
