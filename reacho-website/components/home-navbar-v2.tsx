...
const features = [
  {
    ...
    description: "Build better relationships with customers",
    href: "#",
    icon: (
      <svg
  ...
  {
    name: "SMS marketing",
    description: "Text your customers around the world",
    href: "#",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  },
  {
    ...
    description: "Email & SMS automations to ask your customers for reviews.",
    href: "#",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
                ...
                <Popover className="nav-item nav-item-dropdown">
                  ...
                  <PopoverPanel className="megamenu">
                    <div className="megamenu-body">
                      <div className="feature-submenu-links">
                        {features.map((item) => (
                          <>
                            <div
                              key={item.name}
                              className="group relative flex gap-x-4 rounded-lg p-3 text-sm leading-6 hover:bg-gray-50"
                            >
                              <div className="mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                                <span className="h-5 w-5 text-gray-700 fill-current group-hover:text-indigo-600">
                                  {item.icon}
                                </span>
                              </div>
                      ...
                      <div className="flex-1 max-w-64 bg-gray-50 -my-10 -mx-6 px-6 py-4 rounded-e-xl">
