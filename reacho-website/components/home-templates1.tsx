            ...
            <section className="relative px-6 py-12 md:py-16 lg:py-32 bg-cloud-3 bg-center bg-cover">
                <div className="container max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <div className="relative z-10 text-base sm:text-xl !leading-8 text-center">
                            <p className="sub-text text-base lg:text-2xl leading-[1.6em]  px-0 m-auto">
                                A vast library of free templates for emails, surveys, and landing pages. Beautiful designs to delight your customers every time.
